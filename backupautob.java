 ...
 */
@Autonomous(name = "glyphblue1", group = "Teamcode")
public class backupautob extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Thread.sleep(4000);
        lifttime(.31,1010);
        encoderDrivebyDistance(.4,25,25);
        Thread.sleep(9000);
        encoderTurnByDistance(.2,110,LEFT);
        encoderDrivebyDistance(.3,9,9);
        arml.setPosition(.55);
        armr.setPosition(.5);
